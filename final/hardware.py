...
JOINT1 = Joint(0, 0, 600, 2500, 270, 135, 0, 160)
JOINT2 = Joint(0, 1, 650, 2500, 270, 135, 50, 250)
JOINT3 = Joint(0, 2, 425, 2500, 180, 90, 30, 125)
JOINT4 = Joint(0, 3, 650, 2500, 270, 135, 0, 160)
JOINT5 = Joint(0, 4, 550, 2500, 270, 135, 50, 250)
JOINT6 = Joint(0, 5, 550, 2500, 180, 90, 55, 125)
JOINT7 = Joint(0, 6, 600, 2500, 270, 135, 0, 160)
JOINT8 = Joint(0, 7, 600, 2500, 270, 135, 50, 250)
JOINT9 = Joint(0, 8, 700, 2500, 180, 90, 55, 150)
JOINT10 = Joint(1, 0, 600, 2500, 270, 135, 0, 160)
JOINT11 = Joint(1, 1, 625, 2500, 270, 135, 50, 250)
JOINT12 = Joint(1, 2, 650, 2600, 180, 90, 55, 150, inverted=True)
JOINT13 = Joint(1, 3, 500, 2500, 270, 135, 0, 160)
JOINT14 = Joint(1, 4, 650, 2500, 270, 135, 50, 250)
JOINT15 = Joint(1, 5, 500, 2500, 180, 90, 55, 125, inverted=True)
JOINT16 = Joint(1, 6, 500, 2500, 270, 135, 0, 160)
JOINT17 = Joint(1, 7, 500, 2500, 270, 135, 50, 250)
JOINT18 = Joint(1, 8, 575, 2500, 180, 90, 30, 125, inverted=True)
